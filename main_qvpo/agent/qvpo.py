...
class QVPO(object):
    def __init__(self,
        ...
        self.memory = memory
        self.mixer = HyQMixer(memory, memory, use_offline=args.use_offline, beta_start=args.hyq_beta_start, beta_end=args.hyq_beta_end, anneal_steps=args.hyq_anneal_steps, td_alpha=args.hyq_td_alpha)
        if not self.aug:
